    ...
    >
      <Toolbar>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, color: 'primary.main', py: 1 }}>
          ...
          <Typography variant="h6" noWrap component="div" sx={{ fontWeight: 700, fontFamily: 'Merriweather' }}>
            Osaan Admin
          </Typography>
        </Box>
      </Toolbar>
      ...
      <List sx={{ pt: 2 }}>
        <RequireAdmin>
          ...
          >
            <ListItemIcon sx={{ minWidth: 40, color: isSelected('/skills') ? 'inherit' : 'primary.main' }}>
              <SchoolIcon />
            </ListItemIcon>
            <ListItemText 
              primary={t('skills')} 
        ...
        <RequireAuth>
          ...
          >
            <ListItemIcon sx={{ minWidth: 40, color: isSelected('/employees') ? 'inherit' : 'primary.main' }}>
              <PeopleIcon />
            </ListItemIcon>
            <ListItemText 
              primary={t('employees')} 
