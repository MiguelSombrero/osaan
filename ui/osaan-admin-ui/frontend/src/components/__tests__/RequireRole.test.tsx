...
describe('Route protection scenarios', () => {
  describe('Skills page (requires ADMIN)', () => {
    ...
    it('is NOT accessible to regular users', async () => {
      setMockAuthState(mockRegularUser);
    ...
    it('is NOT accessible to unauthenticated users', async () => {
      setMockAuthState(mockUnauthenticated);
  ...
  describe('Employees page (requires authentication only)', () => {
    it('is accessible to admin users', async () => {
      setMockAuthState(mockAdminUser);
    ...
    it('IS accessible to regular users (non-admin)', async () => {
      setMockAuthState(mockRegularUser);
