package com.github.miguelsombrero.osaan.skill_catalog_service.api.dto;
...
public record GetSkillsResponse(
        @ArraySchema(schema = @Schema(implementation = SkillDto.class, description = "List of skills"), minItems = 0)
